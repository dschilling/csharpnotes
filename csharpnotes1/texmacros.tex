...
\newcommand{\pageone}{
  \begin{titlepage}
    ...
    \vskip 0.2 in
    \centerline{\Large{(with C\# content by Daniel Schilling)}}
    \vskip 1.5 in
    \centerline{This is a PDF version of a free, on-line book that is available}
    \centerline{at https://math.hws.edu/csharpnotes/.  The web site includes}
    ...
    \noindent The web site for this book is:\ \ \ https://math.hws.edu/csharpnotes
...
\newcommand{\pageonelinked}{
  \begin{titlepage}
   ...
   \centerline{\url{https://math.hws.edu/csharpnotes/}.  The PDF does not include}
...
\newcommand{\pageoneluluall}{
  \begin{titlepage}
    ...
    \centerline{available at https://math.hws.edu/csharpnotes/.  The web site}
