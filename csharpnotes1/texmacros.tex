...
\newcommand{\pageone}{
  \begin{titlepage}
    \vglue 1.5 in
    \centerline{\Huge{Introduction to Programming Using C\#}}
    \vskip 0.4 in
    \centerline{\LARGE{Version 1}}
    \vskip 0.1 in
    \centerline{\textit{Publication Date TBD}}
    \vskip 1.5 in
    \centerline{\LARGE{David J. Eck}}
    \vskip 0.2 in
    \centerline{\Large{Hobart and William Smith Colleges}}
    \vskip 0.2 in
    \centerline{\Large{(conversion to C\# by Daniel Schilling)}}
    \vskip 1.5 in
    \centerline{This is a PDF version of a free, on-line book that is available}
    \centerline{at https://codewren.ch/csharpnotes/.  The web site includes}
    ...
    \noindent\copyright 2023, Daniel Schilling
    ...
    \noindent Daniel Schilling (rawdatadaniel@gmail.com)}
    ...
    \noindent The web site for this book is:\ \ \ https://codewren.ch/csharpnotes
...
\newcommand{\pageonelinked}{
  \begin{titlepage}
   ...
   \centerline{\url{https://codewren.ch/csharpnotes/}.  The PDF does not include}
...
\newcommand{\pageoneluluall}{
  \begin{titlepage}
    ...
    \centerline{available at https://codewren.ch/csharpnotes/.  The web site}
